...
![Spark Streaming架构图](ch18\_后端架构选型、离线及实时计算/img/18-2-6-1.png)
...
  将多个数据源组合到单个表格结构中，从而生成数据集。可以多次使用相同的数据集进行模型训练和评估。 ![深度学习集群](ch18\_后端架构选型、离线及实时计算/img/18-2-9-2.png)
...
![E值](ch18\_后端架构选型、离线及实时计算/img/18-9-3-1.png)
