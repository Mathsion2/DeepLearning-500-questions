...
![Spark Streaming架构图](ch18\_后端架构选型及应用场景/img/18-2-6-1.png)
...
  本地缓存 Petastorm 支持在本地存储中缓存数据。当网络连接速度较慢或带宽很昂贵时，这会派上用场。 ![本地缓存](ch18\_后端架构选型及应用场景/img/18-2-9-4.png)
